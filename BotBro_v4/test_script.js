        ...
        if (token) {
            apiFetch('https://sanviraz-botbro-backend.hf.space/me')
                .then(res => res.json())
        ...
        createBtn.onclick = async () => {
            ...
            try {
                const res = await apiFetch('https://sanviraz-botbro-backend.hf.space/create-bot', {
                    method: 'POST',
        ...
        function startPolling() {
            ...
            pollInterval = setInterval(async () => {
                ...
                const res = await apiFetch(`https://sanviraz-botbro-backend.hf.space/bot-status/${currentBot.id}`);
                const data = await res.json();
        ...
        async function saveTheme() {
            ...
            try {
                await apiFetch(`https://sanviraz-botbro-backend.hf.space/bot-settings/${currentBot.id}`, {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
        ...
        async function loadSuggestions(bot_id) {
            ...
            try {
                const res = await apiFetch(`https://sanviraz-botbro-backend.hf.space/suggested-questions/${bot_id}`);
                const data = await res.json();
        ...
        window.refreshSuggestions = async () => {
            ...
            const res = await apiFetch(`https://sanviraz-botbro-backend.hf.space/refresh-suggestions/${currentBot.id}`, {method: 'POST'});
            const data = await res.json();
            renderSuggestions(data.questions);
        };
        ...
        async function renderBotList() {
            ...
            try {
                const res = await apiFetch('https://sanviraz-botbro-backend.hf.space/bots');
        ...
        async function loadBotForEdit(bot_id) {
            ...
            try {
                const res = await apiFetch(`https://sanviraz-botbro-backend.hf.space/bot-settings/${bot_id}`);
        ...
        window.loadAllLeads = async () => {
            try {
                const leads = await apiFetch('https://sanviraz-botbro-backend.hf.space/all-leads');
        ...
        window.loadOrders = async () => {
            try {
                const orders = await apiFetch('https://sanviraz-botbro-backend.hf.space/all-orders');
        ...
        window.updateOrderStatus = async (order_id, status) => {
            try {
                await apiFetch(`https://sanviraz-botbro-backend.hf.space/order-status/${order_id}`, {
                    method: 'POST',
        ...
        window.copySavedCode = (id) => {
            const code = `<script src="https://sanviraz-botbro-backend.hf.space/widget.js" data-bot-id="${id}"></scr` + `ipt>`;
        ...
        window.deleteBot = async (id) => {
            ...
            try {
                await apiFetch(`https://sanviraz-botbro-backend.hf.space/bot/${id}`, { method: 'DELETE' });
        ...
        document.getElementById('preview-send').onclick = async () => {
            ...
            const res = await fetch('https://sanviraz-botbro-backend.hf.space/query', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
